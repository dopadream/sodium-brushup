...
public class DefaultTerrainRenderPasses {
    ...
    public static final TerrainRenderPass CUTOUT = new TerrainRenderPass(RenderType.cutout(), true, true);
    public static final TerrainRenderPass CUTOUT_MIPPED = new TerrainRenderPass(RenderType.cutoutMipped(), false, true);
